...
class ContactTiles extends StatelessWidget {
  ...
  ContactTiles({this.editOn,this.id, this.name, this.relation, this.phoneNumber,});



  void _sendSMS(String message, List<String> recipents) async {
    String _result = await FlutterSms
        .sendSMS(message: message, recipients: recipents).then((val){
    })
        .catchError((onError) {
      print(onError);
    });
            ...
            child: Row(
              ...
              children: <Widget>[
                IconButton(
                  ...
                  onPressed: () {
                    Navigator.of(context).pushNamed(MyForm.routeName,arguments: id);
                  },
                ...
                IconButton(
                  ...
                  onPressed: () {
                    locData.getMyLoc().then((val){
                      ...
                      locData.calMyLocNameAndSubLocality(myLatLng.latitude, myLatLng.longitude).then((val){
                        myLocName = locData.getMyLocName();
                        myLocSubloc = locData.getMyLocSubLocality();
                        message = 'I am currently located at ${myLocName},${myLocSubloc}. Please reach out for me.';
